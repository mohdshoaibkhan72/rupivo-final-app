                    ...
                    <div className="flex flex-col items-center animate-fade-in">
                        <div className="relative w-64 h-40 flex items-end justify-center mb-2">
                            ...
                            <div className="absolute bottom-0 text-center flex flex-col items-center">
                                ...
                                <div className={`text-sm font-bold px-3 py-1 rounded-full mt-1 flex items-center gap-1 ${
                                    score >= 750 ? 'bg-green-50 text-green-600' : 'bg-blue-50 text-blue-600'
                                }`}>
                            ...
                            <div>
                                ...
                                <div className="flex items-center gap-2 mt-0.5">
                                    ...
                                    <span className={`text-[10px] font-bold uppercase tracking-wider ${
                                        factor.impact === 'High' ? 'text-red-500' : factor.impact === 'Medium' ? 'text-orange-500' : 'text-slate-400'
